...
const mockJobs: Job[] = [
  {
    ...
    description:
      "Seeking a talented lead actor for an upcoming drama film about human connections in the digital age.",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Comfortable with bold scenes",
    ],
    description:
      "Looking for a supporting actress for a contemporary web series exploring urban relationships.",
  ...
  },
  {
    ...
    requirements: [
      "Any gender, 40-60 years",
      "Expressive face",
      "Regional language",
    ],
    description:
      "Seeking a character actor for an emotional short film about family bonds and forgiveness.",
...
export default function JobsScreen() {
  ...
  const renderJobCard = (job: Job) => (
    <View
      key={job.id}
      style={[styles.jobCard, job.featured && styles.featuredCard]}
    >
      {job.featured && (
